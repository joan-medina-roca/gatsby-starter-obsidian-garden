  ...
  return (
    <MdxProvider>
      <Layout>
        ...
        <small className="text-sm font-bold uppercase tracking-tight">{post.date}</small>
        <article className="my-6 prose prose-green lg:prose-xl">
          <MDXRenderer>{postNode.body}</MDXRenderer>
        </article>
        <h5 className="uppercase font-bold mb-4">Temes</h5>
        ...
        <h5 className="uppercase font-bold mb-4">Maduresa</h5>
        <small className="bg-green-50 text-green-700 text-xs tracking-normal uppercase rounded-lg px-2 py-1 my-2">{post.stage}</small>
      </Layout>
    </MdxProvider>
  );
};
